...
public class TipoCreditoRestService {
    ...
    public ResponseEntity<String> obtenerPorId(Integer id) {
        String url = "http://34.72.172.227:8080/api/v1/tiposcredito/" + id;
    ...
    public ResponseEntity<String> listar() {
        String url = "http://34.72.172.227:8080/api/v1/tiposcredito";
        ResponseEntity<String> response = restTemplate.getForEntity(url, String.class);
        validarRespuesta(response);
        return response;
    }
    ...
    public ResponseEntity<String> listarActivos() {
        String url = UriComponentsBuilder.fromHttpUrl("http://34.72.172.227:8080/api/v1/tiposcredito")
